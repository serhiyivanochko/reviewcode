package md5dcbe7704a04248f3bad254dd4e8d07c8;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DayMax.Models.GestureListener, DayMax, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GestureListener.class, __md_methods);
	}
	...
	public GestureListener () throws java.lang.Throwable
	{
		...
		if (getClass () == GestureListener.class)
			mono.android.TypeManager.Activate ("DayMax.Models.GestureListener, DayMax, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
